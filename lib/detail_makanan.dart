...
class DetailMakanan extends StatefulWidget {
  ...
  const DetailMakanan({this.makanan});
...
class _DetailMakananState extends State<DetailMakanan> {
  ...
  Padding _buildDescription() {
    return Padding(
          ...
          child: Row(
            children: <Widget>[
              Text(widget.makanan.description,
  ...
  Padding _buildTitle() {
    return Padding(
          padding: const EdgeInsets.only(left: 20.0),
          child: Text(widget.makanan.title, style: TextStyle(fontSize: 25.0, fontWeight: FontWeight.w400),),
        );
  }
